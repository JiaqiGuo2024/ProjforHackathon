...
import { ArrowLeft, Users, Calendar, Clock, Tag, Star } from 'lucide-react';
...
export const EventDetail: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'posters' | 'networking' | 'chat' | 'ratings'>('overview');
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="flex border-b border-gray-200 overflow-x-auto">
            {[
              ...
              { id: 'posters', label: `Poster Gallery (${event.poster_urls.length})` },
              { id: 'networking', label: 'Networking' },
              { id: 'chat', label: `Chat (${messages.length})` },
              { id: 'ratings', label: 'Reviews & Ratings' }
            ].map(tab => (
              <button
                key={tab.id}
          ...
          <div className="p-6">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          {startDateTime.date !== endDateTime.date && (
                            <p className="text-gray-600">to {endDateTime.date}</p>
                          )}
                        </div>
                      </div>
            ...
            {activeTab === 'networking' && (
              <EventNetworking eventId={event.id} />
            )}
